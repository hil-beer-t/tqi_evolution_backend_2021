...
function Listing() {
    ...
    return <>
        <div>
                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navcol-1">
                        <ul className="navbar-nav">
                            <li className="nav-item"><a className="nav-link active" href="#">Nova simulação
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                                     viewBox="0 0 16 16" className="svg-feed bi bi-plus">
                                    <path
            ...
            <h1 className="h1-feed">Suas simulações</h1>
